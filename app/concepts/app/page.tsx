...
export default function AppConceptPage() {
    ...
    const [currentTab, setCurrentTab] = useState<"home" | "offers" | "cart" | "profile">("home");
            ...
            <main className="relative z-10 w-full max-w-[430px] h-[100dvh] sm:h-[90vh] sm:max-h-[900px] sm:rounded-[40px] bg-[#FAFAFA] shadow-2xl overflow-hidden border sm:border-white/50 flex flex-col">
                ...
                <div className="w-full bg-white border-t border-black/5 pt-3 pb-6 px-6 flex justify-between items-end z-50">
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 transition-colors ${currentTab === 'home' ? 'text-brand-green' : 'text-gray-300 hover:text-gray-400'}`}
                    >
                        <svg className="w-6 h-6" fill={currentTab === 'home' ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={currentTab === 'home' ? "0" : "2"} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            {currentTab === 'home' && <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" fill="currentColor" />}
                        </svg>
